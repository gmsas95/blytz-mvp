...
class _AuthApiClient implements AuthApiClient {
  ...
  @override
  Future<AuthModel> getCurrentUser(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
...
class _ProductApiClient implements ProductApiClient {
  ...
  @override
  Future<Map<String, dynamic>> getFeaturedProducts(int limit) async {
    final _extra = <String, dynamic>{};
...
class _AuctionApiClient implements AuctionApiClient {
  _AuctionApiClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
