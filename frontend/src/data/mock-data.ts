import { User, Product, Auction, Livestream, Cart, Order } from '@/types'
...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    description: 'Beautiful teak wood coffee table with clean lines and tapered legs. Iconic mid-century design.',
    price: 599.00,
    images: [
  ...
  },
  {
    ...
    description: 'Pair of handcrafted ceramic table lamps with linen shades. Perfect for bedside tables.',
    price: 179.99,
    images: [
    ...
    bids: [
      {
        ...
        user: { id: '4', name: 'John Doe', email: 'john@example.com', isSeller: false, rating: 0, totalSales: 0, createdAt: '2024-01-01T00:00:00Z' }
      },
      {
        id: '2',
        auctionId: '1',
        ...
        user: { id: '5', name: 'Jane Smith', email: 'jane@example.com', isSeller: false, rating: 0, totalSales: 0, createdAt: '2024-01-01T00:00:00Z' }
      }
    ]
  },
  {
